...
# Filter for tweets with 'elderly' in the text
elderly_tweets = df_to_analyze[df_to_analyze['text'].str.contains
('elderly|the old|seniors|older adults|retirees|silver generation|grandparent|silver|old people|old folks|older|elderly people|elderly adults', case=False)]

print(elderly_tweets.head())
print(elderly_tweets.shape)
...
# Apply LDA
lda = LatentDirichletAllocation(n_components=3, random_state=42)  # 5 topics
lda.fit(dtm)
